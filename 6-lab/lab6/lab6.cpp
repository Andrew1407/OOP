...
HWND hWndOb2, hWndOb3;									// WINDOW "Object2"
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
        {
			...
			case ID_MTXVAL:
			{
				DialogBox(hInst, MAKEINTRESOURCE(IDD_MATRIXDLG), hWnd, MatrixCb);
			}
				break;
            case IDM_EXIT:
                DestroyWindow(hWnd);
    ...
    case WM_DESTROY:
	{
		PostMessage(FindWindow("OBJECT2", NULL), WM_CLOSE, 0, 0);
		PostMessage(FindWindow("OBJECT3", NULL), WM_CLOSE, 0, 0);
		PostQuitMessage(0);
	}
        break;
    default:
